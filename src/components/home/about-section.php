            ...
            <div class="w-full order-2 lg:order-1">
                ...
                <div class="space-y-4 mb-8 sm:mb-10">
                    ...
                    <div class="flex gap-4 items-start">
                        ...
                        <div>
                            <h3 class="text-base sm:text-lg font-semibold text-gray-900">Dedicated Support</h3>
                            <p class="text-sm sm:text-base text-gray-600">Tailored solutions and customer care</p>
                        </div>
                    </div>
                </div>
