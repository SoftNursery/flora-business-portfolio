...
<section id="contact" class="py-24 bg-white text-white">
    <div class="container mx-auto px-6">
        ...
        <div class="text-center mb-12">
            <h2 class="text-4xl md:text-5xl font-serif font-bold mb-4 text-[#1F4A89]">Get A Quote</h2>
        ...
        <div class="">
            ...
            <!-- Form -->
            <div class="bg-white border border-gray-200 shadow-xl transition-colors rounded-xl p-6 w-full lg:w-1/2 mt-6 lg:mt-0 mx-auto">
                <form action="contact_submit.php" method="POST" class="space-y-6">
                    <div>
                        <label for="name" class="block font-medium text-darkGrey">Full Name *</label>
                    ...
                    <div>
                        <label for="email" class="block font-medium text-darkGrey">Email Address *</label>
                    ...
                    <div>
                        <label for="phone" class="block font-medium text-darkGrey">Phone Number *</label>
                    ...
                    <div>
                        <label for="subject" class="block font-medium text-darkGrey">Subject *</label>
                    ...
                    <div>
                        <label for="message" class="block font-medium text-darkGrey">Message *</label>
